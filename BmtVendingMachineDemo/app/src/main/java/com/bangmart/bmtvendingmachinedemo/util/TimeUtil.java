...
import com.bangmart.bmtvendingmachinedemo.constant.TimePatternConstant;
...
public class TimeUtil {
    ...
    /**
     * @param simpleDate "2018-05-30 19-57-05"
     * @param pattern "yyyy-MM-dd HH-mm-ss";//24小时制
     *                 "yyyy-MM-dd hh-mm-ss";//12小时制
     * @return
     */
    public static long getTimeMs(String simpleDate, String pattern){
        long timeMs=0;

        SimpleDateFormat simpleDateFormat=new SimpleDateFormat(pattern);
        try {
            timeMs = simpleDateFormat.parse(simpleDate).getTime();
