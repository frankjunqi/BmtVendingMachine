...
public class DeviceInfoTool {
    ...
    public static String getDeviceId() {
        ...
        try {
            // 先获取androidid
            deviceId = Settings.Secure.getString(NTApplication.getInstance().getContentResolver(), Settings.Secure.ANDROID_ID);
            ...
            if (TextUtils.isEmpty(deviceId) || "9774d56d682e549c".equals(deviceId)) {
                TelephonyManager telephonyManager = (TelephonyManager) NTApplication.getInstance()
